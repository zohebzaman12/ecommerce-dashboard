...
function Home() {
  return (
    <div className="container mx-auto p-4 font-worksans">
      ...
      <div className="mt-8">
        <h2 className="text-customGrayDark text-2xl font-semibold mb-4">
          Recent Activity
        </h2>
        <div className="bg-customGrayLighter p-6 rounded-lg shadow-md">
          <div className="mb-4">
            <span className="text-customGrayDark font-medium">
              📦 Added new product:
            </span>
            <span className="text-customBlue ml-1">Nike Air Max 270</span>
            <span className="block text-sm text-customGrayDark mt-1">
              10 minutes ago
            </span>
          </div>
          ...
          <div className="mb-4">
            <span className="text-customGrayDark font-medium">
              🛒 Large order placed by:
            </span>
            <span className="text-customBlue ml-1">
              John Doe (Order #123456)
            </span>
            <span className="block text-sm text-customGrayDark mt-1">
              4 hours ago
            </span>
