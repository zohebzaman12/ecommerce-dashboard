...
const navItems = [
  ...
  {
    text: "Catalogues",
    icon: <MdOutlineMenuBook size="24px" color="" />,
    link: "/catalogues",
  },
  {
    text: "Promotions",
    icon: <MdOutlineCampaign size="24px" color="" />,
    link: "/promotions",
  },
  {
    text: "Reports",
    icon: <MdOutlineAssessment size="24px" color="" />,
    link: "/reports",
  },
  {
    text: "Docs",
    icon: <BsFillFileEarmarkTextFill size="24px" color="" />,
    link: "/docs",
  },
  {
    text: "Settings",
    icon: <AiOutlineSetting size="24px" color="" />,
    link: "/settings",
  },
];
          ...
          <div className="flex flex-col gap-2 pt-4">
            {navItems.map((element) => (
              <Link
                key={element.text}
                to={element.link}
                className="flex items-center text-sm gap-2 hover:bg-customBlueLight p-2 rounded-md"
              >
                {element.icon}
